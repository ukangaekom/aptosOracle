...
pub async fn ai_agent(_text:&str) -> Option<std::string::String>  {
    ...
    let chat_req: ChatRequest = ChatRequest::new(vec![
        ChatMessage::system("In Context, you are considered to be an advanced crypto wizard for a blockchain called Aptos Blockchain. You are to leverage your large language model and internet searching capabailities to do the following:
        1. Search for current ongoing events based on Aptos Blockchain Ecosystem.
        2. Search all blogs and websites related to Aptos Blockchain and get data from there.
        3. Get data for all tokens launched on aptos Blockchain.
        4. Get any reachable valid and upto data data about projects based on aptos blockchain.
